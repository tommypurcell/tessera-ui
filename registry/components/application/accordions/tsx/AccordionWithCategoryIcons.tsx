...
export type AccordionWithCategoryIconsProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function AccordionWithCategoryIcons({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: AccordionWithCategoryIconsProps) {
