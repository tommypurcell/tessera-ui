...
export type AccordionWithCategoryIconsDarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function AccordionWithCategoryIconsDark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: AccordionWithCategoryIconsDarkProps) {
