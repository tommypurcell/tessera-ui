...
export type ActivityRingTrioVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ActivityRingTrioVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ActivityRingTrioVariant1DarkProps) {
  const defaultContent = (
    <>
      <svg className="size-40 -rotate-90" viewBox="0 0 160 160" role="img" aria-label="Move 420 of 500 calories, Exercise 28 of 30 minutes, Stand 9 of 12 hours">
            <circle cx="80" cy="80" r="70" fill="none" stroke="currentColor" strokeWidth="14" className="text-red-500/15" />
            <circle
              cx="80"
              cy="80"
              r="70"
            ...
            <circle cx="80" cy="80" r="52" fill="none" stroke="currentColor" strokeWidth="14" className="text-green-500/15" />
            <circle
              cx="80"
              cy="80"
              r="52"
            ...
            <circle cx="80" cy="80" r="34" fill="none" stroke="currentColor" strokeWidth="14" className="text-blue-500/15" />
            <circle
              cx="80"
              cy="80"
              r="34"
