...
export function AlertsVariant2({
  ...
  const defaultContent = (
    <>
      <div className="flex gap-3 rounded-lg border border-green-200 bg-green-50 p-4 text-green-800" role="status">
            <svg
              aria-hidden="true"
          ...
          <div className="flex gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-800" role="status">
            <svg
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-800" role="alert">
            <svg
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
