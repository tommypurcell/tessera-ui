...
export type AnnouncementFeedItemVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function AnnouncementFeedItemVariant1({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: AnnouncementFeedItemVariant1Props) {
  const defaultContent = (
    <>
      <article className="rounded-lg border border-amber-200 bg-amber-50/40 p-4">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Product · 2 days ago</p>
                </div>
              </div>
            ...
            <h2 className="mt-3 text-sm font-semibold text-gray-900">Introducing the new component playground</h2>
            ...
            <div className="mt-4 flex items-center gap-4 border-t border-amber-200/70 pt-3">
              <button type="button" className="flex items-center gap-1.5 text-sm text-gray-500 transition hover:text-gray-700">
