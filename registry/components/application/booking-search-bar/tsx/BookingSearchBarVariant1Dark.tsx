export function BookingSearchBarVariant1Dark() {
  return (
    <div className="flex items-stretch divide-x divide-gray-800 rounded-full border border-gray-800 bg-gray-900 shadow-sm">
      <label className="flex flex-1 flex-col gap-0.5 px-5 py-2.5">
        <span className="text-[11px] font-semibold text-white">Where</span>
        <input
          type="text"
      ...
      <label className="flex flex-1 flex-col gap-0.5 px-5 py-2.5">
        <span className="text-[11px] font-semibold text-white">Check in</span>
      ...
      <label className="flex flex-1 flex-col gap-0.5 px-5 py-2.5">
        <span className="text-[11px] font-semibold text-white">Check out</span>
        <input type="text" placeholder="Add dates" className="w-full border-0 bg-transparent p-0 text-sm text-gray-200 placeholder:text-gray-500 focus:ring-0 focus:outline-none" />
      </label>

      <label className="flex flex-1 flex-col gap-0.5 py-2.5 pr-2 pl-5">
        <span className="text-[11px] font-semibold text-white">Who</span>
      ...
      <div className="flex items-center pr-2">
        <button type="submit" aria-label="Search" className="flex size-11 items-center justify-center rounded-full bg-rose-600 text-white hover:bg-rose-500">
