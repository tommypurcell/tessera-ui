...
export type BottomSheetNavVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function BottomSheetNavVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: BottomSheetNavVariant1DarkProps) {
  const defaultContent = (
    <>
<div className="relative h-[520px] w-[300px] overflow-hidden rounded-[2rem] border-8 border-black bg-gray-950 shadow-xl">
      <div className="flex items-center justify-between px-4 pt-3 text-xs font-medium text-gray-400">
        <span>9:41</span>
        <span>●●●</span>
      </div>
      <div className="flex h-14 items-center border-b border-gray-800 px-4 text-sm font-semibold text-white">Explore</div>
      <div className="grid grid-cols-3 gap-2 p-4">
        <div className="aspect-square rounded-lg bg-gray-800"></div>
        <div className="aspect-square rounded-lg bg-gray-800"></div>
        <div className="aspect-square rounded-lg bg-gray-800"></div>
        <div className="aspect-square rounded-lg bg-gray-800"></div>
        <div className="aspect-square rounded-lg bg-gray-800"></div>
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 rounded-t-2xl border-t border-gray-700 bg-gray-900 shadow-[0_-8px_24px_-8px_rgba(0,0,0,0.6)]">
        <div className="flex justify-center pt-2.5 pb-1">
          <span className="h-1 w-9 rounded-full bg-gray-600"></span>
        </div>

        <div className="flex items-center justify-between px-4 pb-1 pt-1">
          <p className="text-sm font-semibold text-white">Filter results</p>
        ...
        <nav className="grid grid-cols-4 gap-1 px-3 pb-6 pt-3">
          <button type="button" className="flex flex-col items-center gap-1 rounded-lg py-2 text-white">
          ...
          <button type="button" className="flex flex-col items-center gap-1 rounded-lg py-2 text-gray-500">
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" className="size-5">
