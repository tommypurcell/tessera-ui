...
export type BreadcrumbsVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function BreadcrumbsVariant2Dark({
  className,
  children,
  renderContent,
  before,
