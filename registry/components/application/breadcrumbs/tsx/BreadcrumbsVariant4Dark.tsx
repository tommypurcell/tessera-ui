...
export type BreadcrumbsVariant4DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function BreadcrumbsVariant4Dark({
  className,
  children,
  renderContent,
  before,
