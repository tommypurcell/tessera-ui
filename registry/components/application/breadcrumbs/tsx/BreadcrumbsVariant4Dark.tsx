...
export type BreadcrumbsVariant4DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function BreadcrumbsVariant4Dark({ className, ...props }: BreadcrumbsVariant4DarkProps) {
  return (
