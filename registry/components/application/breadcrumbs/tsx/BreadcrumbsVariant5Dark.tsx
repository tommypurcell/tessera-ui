...
export type BreadcrumbsVariant5DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function BreadcrumbsVariant5Dark({
  className,
  children,
  renderContent,
  before,
