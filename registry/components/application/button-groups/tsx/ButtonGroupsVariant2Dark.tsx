...
export type ButtonGroupsVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ButtonGroupsVariant2Dark({
  className,
  children,
  renderContent,
  before,
