...
export type ButtonGroupsVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ButtonGroupsVariant3Dark({
  className,
  children,
  renderContent,
  before,
