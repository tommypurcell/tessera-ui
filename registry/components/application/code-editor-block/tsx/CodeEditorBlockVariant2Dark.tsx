...
export type CodeEditorBlockVariant2DarkProps = {
  fileName: string
...
/**
 * Copy-and-own Tailwind component. File-name header and copy-action code
 * block adapted for a dark page surface.
 */
export function CodeEditorBlock({ fileName, lines, ariaLabel, onCopy }: CodeEditorBlockVariant2DarkProps) {
  return (
