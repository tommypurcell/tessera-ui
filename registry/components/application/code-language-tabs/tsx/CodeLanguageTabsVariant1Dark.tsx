...
export type CodeLanguageTabsVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function CodeLanguageTabsVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: CodeLanguageTabsVariant1DarkProps) {
