...
export type CodeLanguageTabsVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function CodeLanguageTabsVariant2({
  className,
  children,
  renderContent,
  before,
