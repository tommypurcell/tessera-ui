...
export type ComparisonSliderVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ComparisonSliderVariant2({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ComparisonSliderVariant2Props) {
  const defaultContent = (
    <>
      <div id="compare-2" className="group relative aspect-video w-full overflow-hidden rounded-lg select-none">
            <img
            ...
            >
              <span className="absolute top-1/2 left-1/2 flex size-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-gray-700 shadow-lg">
