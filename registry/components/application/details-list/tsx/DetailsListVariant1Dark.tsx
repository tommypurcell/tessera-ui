...
export type DetailsListVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function DetailsListVariant1Dark({
  className,
  children,
  renderContent,
  before,
