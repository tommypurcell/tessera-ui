...
export type DetailsListVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function DetailsListVariant2Dark({
  className,
  children,
  renderContent,
  before,
