...
export type DetailsListVariant3DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function DetailsListVariant3Dark({ className, ...props }: DetailsListVariant3DarkProps) {
  return (
