...
export type DetailsListVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function DetailsListVariant3Dark({
  className,
  children,
  renderContent,
  before,
