...
export type DetailsListVariant4DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function DetailsListVariant4Dark({ className, ...props }: DetailsListVariant4DarkProps) {
  return (
    <div className={className} {...props}>
      <div className="flow-root">
        <dl className="-my-3 divide-y divide-gray-200 rounded border border-gray-200 text-sm *:even:bg-gray-50 dark:divide-gray-700 dark:border-gray-800 dark:*:even:bg-gray-800">
