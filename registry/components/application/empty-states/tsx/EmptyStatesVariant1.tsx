...
export type EmptyStatesVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function EmptyStatesVariant1({
  className,
  children,
  renderContent,
  before,
    ...
    <>
      <div className="max-w-md text-center">
            ...
            <p className="mt-6 text-sm text-gray-700">
              <a href="#" className="underline hover:text-gray-900">Learn how</a> or
              <a href="#" className="underline hover:text-gray-900">view examples</a>
            </p>
          </div>
    </>
  )
