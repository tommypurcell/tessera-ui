...
export type EmptyStatesVariant4DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function EmptyStatesVariant4Dark({
  className,
  children,
  renderContent,
  before,
  ...
  const defaultContent = (
    <>
      <div className="max-w-md text-center">
            ...
            <h2 className="mt-6 text-2xl font-bold text-gray-900 dark:text-white">Get started in seconds</h2>
            ...
            <ol className="mt-6 space-y-2 text-left">
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-200">Create your first project</span>
              </li>
