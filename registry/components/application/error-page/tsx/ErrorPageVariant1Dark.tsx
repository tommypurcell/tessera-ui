export function ErrorPageVariant1Dark() {
  return (
    <div className="flex min-h-96 flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Page not found</h1>
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <a href="#" className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-300 hover:text-white">
