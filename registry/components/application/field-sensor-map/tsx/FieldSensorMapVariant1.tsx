...
export type FieldSensorMapVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
  children?: ReactNode
...
export function FieldSensorMapVariant1({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: FieldSensorMapVariant1Props) {
  const defaultContent = (
    <>
      <div className="w-full max-w-lg rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-gray-200 p-4">
        <div>
          <h2 className="text-sm font-semibold text-gray-900">North Field — Sensor Map</h2>
          <p className="text-xs text-gray-500">18 plots · updated 4 min ago</p>
        </div>
        <div className="flex items-center gap-3 text-xs text-gray-500">
          <span className="flex items-center gap-1"><span className="size-2.5 rounded-sm bg-amber-300"></span>Dry</span>
          <span className="flex items-center gap-1"><span className="size-2.5 rounded-sm bg-sky-300"></span>Moist</span>
      ...
      <div className="grid grid-cols-6 gap-1.5 p-4">
        <button type="button" className="flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-sky-300 text-white transition hover:ring-2 hover:ring-gray-900 hover:ring-offset-1">
        ...
        <button type="button" className="flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-amber-300 text-white transition hover:ring-2 hover:ring-gray-900 hover:ring-offset-1">
          <span className="text-[11px] font-semibold">A3</span>
          <span className="text-[10px] font-medium">71°F</span>
        </button>
        <button type="button" className="flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-amber-400 text-white transition hover:ring-2 hover:ring-gray-900 hover:ring-offset-1">
        ...
        <button type="button" className="flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-sky-600 text-white transition hover:ring-2 hover:ring-gray-900 hover:ring-offset-1">
        ...
        <button type="button" aria-current="true" className="relative flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-amber-400 text-white ring-2 ring-gray-900 ring-offset-1 transition">
          <span className="text-[11px] font-semibold">B3</span>
          <span className="text-[10px] font-medium">74°F</span>
        </button>
        <button type="button" className="flex aspect-square flex-col items-center justify-center gap-0.5 rounded-md bg-amber-500 text-white transition hover:ring-2 hover:ring-gray-900 hover:ring-offset-1">
      ...
      <div className="flex items-center justify-between border-t border-gray-200 px-4 py-2.5">
        <p className="text-xs text-gray-500">Selected: <span className="font-medium text-gray-900">B3</span> · 22% VWC · 74°F</p>
        <button type="button" className="text-xs font-medium text-gray-600 hover:text-gray-900">View history</button>
      </div>
    </div>
    </>
  )
