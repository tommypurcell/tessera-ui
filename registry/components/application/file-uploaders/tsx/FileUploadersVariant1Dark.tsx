...
export type FileUploadersVariant1DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function FileUploadersVariant1Dark({ className, ...props }: FileUploadersVariant1DarkProps) {
  return (
