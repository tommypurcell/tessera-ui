...
export type FileUploadersVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children' | 'onChange'> & {
 ...
 */
export function FileUploadersVariant1Dark({
  className,
  value,
  onChange,
  multiple = true,
  ...props
}: FileUploadersVariant1DarkProps) {
  const inputId = useId()
  ...
  return (
    <div className={className} {...props}>
      <label
        ...
        onDrop={handleDrop}
        className={`block rounded border bg-white p-4 text-gray-900 shadow-sm sm:p-6 dark:bg-gray-900 dark:text-white ${
