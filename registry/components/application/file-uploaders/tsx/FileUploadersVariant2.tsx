...
export type FileUploadersVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children' | 'onChange'> & {
 ...
 */
export function FileUploadersVariant2({
  className,
  value,
  onChange,
  multiple = true,
  ...props
}: FileUploadersVariant2Props) {
  const inputId = useId()
  ...
  return (
    <div className={className} {...props}>
      <label
        ...
        onDrop={handleDrop}
        className={`flex flex-col items-center rounded border p-4 text-gray-900 shadow-sm sm:p-6 ${
