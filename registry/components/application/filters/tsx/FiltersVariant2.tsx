...
export type FiltersVariant2Props = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function FiltersVariant2({ className, ...props }: FiltersVariant2Props) {
  return (
    <div className={className} {...props}>
      <div className="space-y-4">
            <details className="group relative overflow-hidden rounded border border-gray-300 shadow-sm">
              <summary
                className="flex items-center justify-between gap-2 p-3 text-gray-700 transition-colors hover:text-gray-900 [&::-webkit-details-marker]:hidden"
              >
