    ...
    <div className={className} {...props}>
      <div className="space-y-4">
        <details className="group relative overflow-hidden rounded border border-gray-300 shadow-sm dark:border-gray-600">
          <summary className="flex items-center justify-between gap-2 p-3 text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-200 dark:hover:text-white [&::-webkit-details-marker]:hidden">
          ...
          <div className="divide-y divide-gray-300 border-t border-gray-300 bg-white dark:divide-gray-600 dark:border-gray-600 dark:bg-gray-900">
