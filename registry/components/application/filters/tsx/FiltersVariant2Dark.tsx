...
export type FiltersVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function FiltersVariant2Dark({ className, ...props }: FiltersVariant2DarkProps) {
  return (
    <div className={className} {...props}>
      <div className="space-y-4">
            <details
              className="group relative overflow-hidden rounded border border-gray-300 shadow-sm dark:border-gray-600"
            >
              <summary
                className="flex items-center justify-between gap-2 p-3 text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-200 dark:hover:text-white [&::-webkit-details-marker]:hidden"
              >
              ...
              <div
                className="divide-y divide-gray-300 border-t border-gray-300 bg-white dark:divide-gray-600 dark:border-gray-600 dark:bg-gray-900"
              >
            ...
            >
              ...
              >
                <div className="flex items-center justify-between px-3 py-2">
                  ...
                  <button
                    type="button"
                    className="text-sm text-gray-700 underline transition-colors hover:text-gray-900 dark:text-gray-200"
                  >
                    Reset
                  </button>
                </div>
