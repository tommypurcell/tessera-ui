...
export type FormRowVariant1DarkProps = {
  label: string
  htmlFor?: string
  helpText?: string
  error?: string
    ...
    isValidElement(children)
      ...
      : (
          <input
            ...
            aria-invalid={error ? true : undefined}
            aria-describedby={describedBy}
            className="rounded-md border border-gray-700 bg-gray-900 px-3 py-2 text-sm text-white shadow-sm focus:border-gray-500 focus:outline-none"
          />
        )
