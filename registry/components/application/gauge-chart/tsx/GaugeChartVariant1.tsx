...
export type GaugeChartVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function GaugeChartVariant1({
  className,
  children,
  renderContent,
  before,
    ...
    <>
      <div className="w-full max-w-xs rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <div className="mt-2" role="img" aria-label="Gauge showing 72 percent, in the warning zone">
              <svg viewBox="0 0 200 100" className="w-full">
                ...
                <g transform="rotate(129.6 100 100)">
                  <line x1="100" y1="100" x2="100" y2="45" stroke="#111827" strokeWidth="4" strokeLinecap="round" />
                </g>
            ...
            <div className="mt-1 flex items-center justify-between text-xs text-gray-500">
              <span>0</span>
              <span className="font-medium text-amber-600">Warning zone</span>
              <span>100</span>
            </div>
          </div>
    </>
