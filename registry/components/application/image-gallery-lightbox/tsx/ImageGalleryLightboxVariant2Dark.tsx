...
export type ImageGalleryLightboxVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ImageGalleryLightboxVariant2Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ImageGalleryLightboxVariant2DarkProps) {
...
<div role="dialog" aria-modal="true" aria-label="Image viewer" className="relative flex h-full min-h-96 w-full flex-col">
      <div className="flex items-center justify-between px-4 py-3">
        <span className="text-sm font-medium text-white/70">3 / 12</span>
        <button type="button" aria-label="Close" className="rounded-full p-1.5 text-white/60 transition-colors hover:bg-white/10 hover:text-white">
      ...
      <div className="relative flex flex-1 items-center justify-center px-4">
        ...
        <div className="aspect-[4/3] w-full max-w-sm overflow-hidden rounded-lg bg-gradient-to-br from-amber-500 to-amber-700 shadow-2xl"></div>
