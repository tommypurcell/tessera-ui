export function InventoryLevelRowVariant1Dark() {
  return (
    <div className="rounded-lg border border-amber-900/60 bg-amber-950/20 p-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-sm font-medium text-white">Wireless Mouse &ndash; Black</p>
          <p className="text-xs text-gray-500">SKU WM-2201-BLK</p>
        </div>
        <span className="inline-flex items-center gap-1 rounded-full bg-amber-900/50 px-2 py-0.5 text-xs font-medium text-amber-300">
      ...
      <div className="relative mt-3 h-2.5 w-full rounded-full bg-gray-800">
