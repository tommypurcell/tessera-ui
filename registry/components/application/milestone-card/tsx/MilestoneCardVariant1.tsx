...
export type MilestoneCardVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function MilestoneCardVariant1({
  className,
  children,
  renderContent,
  before,
    ...
    <>
      <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex items-start justify-between">
              ...
              <span className="text-xs text-gray-400">Due Oct 15</span>
            </div>
      
            <h3 className="mt-2.5 text-sm font-semibold text-gray-900">Public beta launch</h3>
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span>Progress</span>
                <span className="font-medium text-gray-900">7/10 tasks</span>
              </div>
              <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-gray-100">
                <div className="h-full w-[70%] rounded-full bg-indigo-600"></div>
              </div>
            </div>
            ...
            <div className="mt-3 flex items-center justify-between border-t border-gray-100 pt-3">
              ...
              <a href="#" className="text-xs font-medium text-gray-600 hover:text-gray-900 hover:underline">View tasks</a>
            </div>
          </div>
    </>
  )
