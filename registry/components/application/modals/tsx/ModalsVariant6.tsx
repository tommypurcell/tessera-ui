...
export type ModalsVariant6Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function ModalsVariant6({ className, ...props }: ModalsVariant6Props) {
  return (
        ...
        <div className="flex flex-col gap-4">
          ...
          <label htmlFor="Confirm" className="block">
            ...
            <input
              type="text"
              id="Confirm"
              className="mt-0.5 w-full rounded border-gray-300 bg-white text-gray-900 shadow-sm sm:text-sm"
            />
          </label>
