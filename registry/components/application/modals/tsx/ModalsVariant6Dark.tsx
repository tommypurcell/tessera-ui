...
export type ModalsVariant6DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function ModalsVariant6Dark({ className, ...props }: ModalsVariant6DarkProps) {
  return (
        ...
        <div className="flex flex-col gap-4">
          ...
          <label htmlFor="Confirm" className="block">
            ...
            <input
              type="text"
              id="Confirm"
              className="mt-0.5 w-full rounded border-gray-300 bg-white text-gray-900 shadow-sm sm:text-sm dark:border-gray-600 dark:bg-gray-900 dark:text-white"
            />
          </label>
