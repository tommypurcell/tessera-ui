...
export type PaginationVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function PaginationVariant2Dark({ className, ...props }: PaginationVariant2DarkProps) {
  return (
