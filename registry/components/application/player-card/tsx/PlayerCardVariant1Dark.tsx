export type PlayerQuickStatDark = {
  label: string
  value: string
}

export type PlayerCardVariant1DarkProps = {
  gamertag: string
  initials: string
  rankTier: string
  stats: PlayerQuickStatDark[]
}
 ...
 */
export function PlayerCardDark({ gamertag, initials, rankTier, stats }: PlayerCardVariant1DarkProps) {
  return (
    <div className="w-full max-w-xs overflow-hidden rounded-xl border border-gray-700 bg-gray-900 shadow-sm">
      <div className="flex items-center gap-3 bg-gradient-to-br from-violet-600 to-blue-700 p-4">
