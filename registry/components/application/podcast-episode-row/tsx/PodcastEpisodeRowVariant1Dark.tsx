...
/**
 * Copy-and-own Tailwind component. Dark-surface variant of the podcast
 * episode row list.
 */
      ...
      {episodes.map((episode) => (
        <li key={episode.title} className="flex items-center gap-3 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-medium text-gray-100">{episode.title}</p>
          ...
          <button
            ...
            className="inline-flex size-8 shrink-0 items-center justify-center rounded-full text-gray-400 hover:bg-gray-800 hover:text-gray-100"
          >
