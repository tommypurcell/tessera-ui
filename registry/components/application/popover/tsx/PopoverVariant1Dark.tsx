...
export type PopoverVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function PopoverVariant1Dark({
  className,
  children,
  renderContent,
  before,
    ...
    <>
      <div className="relative inline-block">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md border border-gray-700 bg-gray-900 px-3 py-2 text-sm font-medium text-gray-200 shadow-sm transition-colors hover:bg-gray-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-100 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950"
            >
            ...
            <div
              ...
              className="absolute left-1/2 top-full z-10 mt-2 w-72 -translate-x-1/2 rounded-lg border border-gray-700 bg-gray-900 p-4 text-left shadow-lg shadow-black/40"
            >
              ...
              <div className="relative">
                ...
                <a href="#" className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-white hover:underline">
                  Learn more
