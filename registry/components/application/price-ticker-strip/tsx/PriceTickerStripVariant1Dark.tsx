...
export type PriceTickerStripVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function PriceTickerStripVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: PriceTickerStripVariant1DarkProps) {
  const defaultContent = (
    <>
      <div className="overflow-hidden rounded-lg border border-gray-800 bg-gray-900 py-3">
            <div className="ticker-track flex w-max items-center gap-8 px-4">
              <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <span className="font-mono text-sm text-gray-300">$67,214.50</span>
              ...
              <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <span className="font-mono text-sm text-gray-300">$3,481.20</span>
              ...
              <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <span className="font-mono text-sm text-gray-300">$178.63</span>
                <span className="flex items-center gap-0.5 text-xs font-medium text-green-400">
                  <svg className="size-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 4l8 10H4l8-10z" /></svg>
                  5.7%
                </span>
              ...
              <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <span className="font-mono text-sm text-gray-300">$227.85</span>
                <span className="flex items-center gap-0.5 text-xs font-medium text-green-400">
                  <svg className="size-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 4l8 10H4l8-10z" /></svg>
                  0.6%
                </span>
