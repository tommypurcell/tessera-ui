...
export type RadioGroupsVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function RadioGroupsVariant2Dark({ className, ...props }: RadioGroupsVariant2DarkProps) {
  return (
