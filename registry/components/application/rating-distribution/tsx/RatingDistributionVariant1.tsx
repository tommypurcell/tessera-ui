...
export type RatingDistributionVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function RatingDistributionVariant1({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: RatingDistributionVariant1Props) {
            ...
            <div className="flex items-center gap-4">
              <div className="text-center">
                ...
                <div className="mt-1 flex items-center gap-0.5 text-yellow-400" aria-hidden="true">
                  ...
                  <svg className="size-3.5" viewBox="0 0 20 20" fill="currentColor"><path d="M9.05 2.93c.3-.92 1.6-.92 1.9 0l1.36 4.18a1 1 0 00.95.69h4.4c.97 0 1.37 1.24.59 1.81l-3.56 2.59a1 1 0 00-.36 1.12l1.36 4.18c.3.92-.76 1.68-1.54 1.11l-3.56-2.58a1 1 0 00-1.18 0l-3.56 2.58c-.78.57-1.84-.19-1.54-1.11l1.36-4.18a1 1 0 00-.36-1.12L1.4 9.6c-.78-.57-.38-1.81.59-1.81h4.4a1 1 0 00.95-.69z" /></svg>
                  <svg className="size-3.5" viewBox="0 0 20 20" fill="currentColor"><path d="M9.05 2.93c.3-.92 1.6-.92 1.9 0l1.36 4.18a1 1 0 00.95.69h4.4c.97 0 1.37 1.24.59 1.81l-3.56 2.59a1 1 0 00-.36 1.12l1.36 4.18c.3.92-.76 1.68-1.54 1.11l-3.56-2.58a1 1 0 00-1.18 0l-3.56 2.58c-.78.57-1.84-.19-1.54-1.11l1.36-4.18a1 1 0 00-.36-1.12L1.4 9.6c-.78-.57-.38-1.81.59-1.81h4.4a1 1 0 00.95-.69z" /></svg>
                  <svg className="size-3.5 text-gray-200" viewBox="0 0 20 20" fill="currentColor"><path d="M9.05 2.93c.3-.92 1.6-.92 1.9 0l1.36 4.18a1 1 0 00.95.69h4.4c.97 0 1.37 1.24.59 1.81l-3.56 2.59a1 1 0 00-.36 1.12l1.36 4.18c.3.92-.76 1.68-1.54 1.11l-3.56-2.58a1 1 0 00-1.18 0l-3.56 2.58c-.78.57-1.84-.19-1.54-1.11l1.36-4.18a1 1 0 00-.36-1.12L1.4 9.6c-.78-.57-.38-1.81.59-1.81h4.4a1 1 0 00.95-.69z" /></svg>
                </div>
                <p className="mt-1 text-xs text-gray-500">1,204 ratings</p>
              </div>
              ...
              <div className="flex-1 space-y-1.5" role="list" aria-label="Rating breakdown">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className="w-8 text-right text-gray-500">72%</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className="w-8 text-right text-gray-500">18%</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className="w-8 text-right text-gray-500">6%</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
