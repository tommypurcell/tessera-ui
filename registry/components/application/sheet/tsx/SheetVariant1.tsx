...
export type SheetVariant1Props = {
  open: boolean
  onClose: () => void
  title: string
  description?: string
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        ...
        className="relative flex h-dvh w-full max-w-sm flex-col bg-white shadow-2xl"
      >
        <div className="flex items-start justify-between gap-4 border-b border-gray-200 px-6 py-5">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="-me-2 -mt-1 rounded-full p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 focus:outline-none"
          >
