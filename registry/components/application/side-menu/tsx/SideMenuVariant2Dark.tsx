...
export type SideMenuVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function SideMenuVariant2Dark({ className, ...props }: SideMenuVariant2DarkProps) {
  return (
      ...
      <div className="flex h-screen w-16 flex-col justify-between border-e border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-900">
        <div>
          <div className="inline-flex size-16 items-center justify-center">
            <span className="grid size-12 place-content-center rounded-lg bg-gray-100 text-sm text-gray-500 dark:bg-gray-800 dark:text-gray-400">
              L
            </span>
          </div>
          ...
          <ul className="space-y-1 border-t border-gray-100 px-2 pt-4 dark:border-gray-800">
            <li>
              ...
              >
                ...
                <span className="invisible absolute inset-s-full top-1/2 ms-4 -translate-y-1/2 rounded-sm bg-gray-200 px-2 py-1.5 text-xs font-medium text-gray-700 group-hover:visible dark:bg-gray-700 dark:text-gray-200">
                  General
                </span>
              </a>
            </li>
