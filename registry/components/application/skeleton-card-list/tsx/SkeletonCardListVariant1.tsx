export function SkeletonCardListVariant1() {
  return (
    <div className="grid grid-cols-3 gap-4" role="status" aria-label="Loading cards">
      {Array.from({ length: 3 }).map((_, index) => (
        <div key={index} className="flex flex-col gap-3 overflow-hidden rounded-lg border border-gray-200 p-3">
          <div className="aspect-video w-full animate-pulse rounded-md bg-gray-200" />
