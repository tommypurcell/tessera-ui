...
export type StepsVariant1DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function StepsVariant1Dark({ className, ...props }: StepsVariant1DarkProps) {
  return (
    <div className={className} {...props}>
      <div>
        ...
        <div>
          ...
          <ol className="mt-4 grid grid-cols-3 text-sm font-medium text-gray-600 dark:text-gray-300">
            ...
            <li className="flex items-center justify-center text-blue-500 sm:gap-1.5">
              <span className="sr-only sm:not-sr-only sm:inline"> Address </span>
            ...
            <li className="flex items-center justify-end sm:gap-1.5">
              <span className="sr-only sm:not-sr-only sm:inline"> Payment </span>
