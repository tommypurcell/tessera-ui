...
export type StepsVariant4Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function StepsVariant4({ className, ...props }: StepsVariant4Props) {
  return (
          ...
          <ol className="grid grid-cols-1 divide-x divide-gray-100 overflow-hidden rounded-lg border border-gray-100 text-sm text-gray-600 sm:grid-cols-3">
            <li className="flex items-center justify-center gap-2 p-4">
              ...
              <p className="leading-none">
                <strong className="block font-medium text-gray-900"> Details </strong>
            ...
            <li className="flex items-center justify-center gap-2 p-4">
              ...
              <p className="leading-none">
                <strong className="block font-medium text-gray-900"> Payment </strong>
