export function StoryRingRowVariant1Dark() {
  return (
    <ul className="flex gap-4 overflow-x-auto pb-1" aria-label="Stories">
      <li className="flex shrink-0 flex-col items-center gap-1.5">
        <button
          ...
          className="relative flex size-16 items-center justify-center rounded-full border-2 border-dashed border-gray-700 text-gray-500 hover:border-gray-600 hover:text-gray-400"
        >
      ...
      <li className="flex shrink-0 flex-col items-center gap-1.5">
        ...
        <span className="text-xs text-gray-400">Marcus</span>
      </li>

      <li className="flex shrink-0 flex-col items-center gap-1.5">
        <span className="inline-flex rounded-full bg-gray-700 p-1">
          <span className="inline-flex rounded-full bg-gray-950 p-0.5">
            <img
        ...
        <span className="text-xs text-gray-500">Sofia</span>
      </li>
    </ul>
  )
}
