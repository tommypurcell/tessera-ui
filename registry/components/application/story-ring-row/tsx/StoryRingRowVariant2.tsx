export function StoryRingRowVariant2() {
  return (
    <ul className="flex gap-3" aria-label="Stories">
      ...
      <li>
        <button
          ...
          className="flex size-11 items-center justify-center rounded-full bg-gray-100 text-xs font-semibold text-gray-600 hover:bg-gray-200"
        >
          +5
        </button>
      </li>
