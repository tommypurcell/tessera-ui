...
export type TablesVariant5Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function TablesVariant5({ className, ...props }: TablesVariant5Props) {
  return (
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y-2 divide-gray-200">
          ...
          <tbody className="divide-y divide-gray-200">
            <tr className="*:text-gray-900 *:first:sticky *:first:left-0 *:first:bg-white *:first:font-medium">
