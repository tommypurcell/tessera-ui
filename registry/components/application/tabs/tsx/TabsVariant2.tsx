...
export type TabsVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
      ...
      <div className="border-b border-gray-200">
        <div role="tablist" className="-mb-px flex gap-4">
          <button
            role="tab"
            aria-selected="true"
            className="flex items-center gap-2 border-b-2 border-blue-600 px-4 py-2 text-sm font-medium text-blue-600 transition-colors hover:text-blue-700"
          >
            <svg
              aria-hidden="true"
          ...
          <button
            role="tab"
            aria-selected="false"
            className="flex items-center gap-2 border-b-2 border-transparent px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-gray-700"
          >
            <svg
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
