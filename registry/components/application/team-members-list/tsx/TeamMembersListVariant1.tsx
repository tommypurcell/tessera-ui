...
export type TeamMembersListVariant1Props = {
  members: TeamMember[]
  ...
  return (
    <li className="flex items-center gap-3 px-4 py-3">
      {member.avatarSrc ? (
        ...
        <div className="flex size-9 shrink-0 items-center justify-center rounded-full bg-gray-100 text-xs font-semibold text-gray-500">
      ...
      {member.pending ? (
        ...
        <>
          ...
          <select
            ...
            className="rounded-md border border-gray-300 bg-white py-1 pl-2 pr-7 text-xs font-medium text-gray-700 shadow-sm focus:border-gray-500 focus:outline-none"
          >
...
/**
 * Copy-and-own Tailwind component. Row-based team management list — avatar, name/email,
 * a per-row role select (or pending-invite badge), and a remove action, all wired to
 * real handlers.
 */
export function TeamMembersListVariant1({
  members,
