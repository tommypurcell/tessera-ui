...
export type TerminalBlocksVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function TerminalBlocksVariant3Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: TerminalBlocksVariant3DarkProps) {
