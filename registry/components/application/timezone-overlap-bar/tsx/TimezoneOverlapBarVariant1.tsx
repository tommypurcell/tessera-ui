export function TimezoneOverlapBarVariant1() {
  return (
    <div className="rounded-lg border border-gray-200 p-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-gray-900">Working hours overlap</h3>
        <p className="text-xs font-medium text-indigo-600">4h overlap</p>
      </div>

      <div className="mt-4 flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <span className="w-24 shrink-0 text-xs font-medium text-gray-600">San Francisco</span>
          <div className="relative h-6 flex-1 rounded-md bg-gray-100">
            <div className="absolute inset-y-0 rounded-md bg-indigo-200" style={{ left: '37.5%', width: '33.3%' }} />
        ...
        <div className="flex items-center gap-3">
          <span className="w-24 shrink-0 text-xs font-medium text-gray-600">London</span>
          <div className="relative h-6 flex-1 rounded-md bg-gray-100">
            <div className="absolute inset-y-0 rounded-md bg-indigo-200" style={{ left: '41.6%', width: '33.3%' }} />
            <div className="absolute inset-y-0 rounded-md bg-indigo-500" style={{ left: '41.6%', width: '16.6%' }} />
          </div>
          <span className="w-16 shrink-0 text-right text-xs text-gray-500">5pm&ndash;1am</span>
        </div>

        <div className="ml-[108px] flex justify-between text-[10px] text-gray-400">
          <span>12am</span>
          <span>6am</span>
          <span>12pm</span>
          <span>6pm</span>
