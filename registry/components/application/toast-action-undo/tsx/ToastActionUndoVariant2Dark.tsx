...
export type ToastActionUndoVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ToastActionUndoVariant2Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ToastActionUndoVariant2DarkProps) {
  const defaultContent = (
    <>
      <div role="status" aria-live="polite" className="w-full overflow-hidden rounded-lg border border-gray-700 bg-gray-800 text-white shadow-lg">
