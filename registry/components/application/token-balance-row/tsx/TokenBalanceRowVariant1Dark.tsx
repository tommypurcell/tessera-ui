...
export type TokenBalanceRowVariant1DarkProps = {
  tokens: TokenBalanceDark[]
}
 ...
 */
export function TokenBalanceRowDark({ tokens }: TokenBalanceRowVariant1DarkProps) {
  return (
        ...
        return (
          <li key={token.symbol} className="flex items-center justify-between gap-3 px-4 py-3">
            ...
            <div className="text-right">
              <p className="font-mono text-sm font-semibold text-white">{token.usdValue}</p>
