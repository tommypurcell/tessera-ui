...
export type UpNextAutoplayCardVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function UpNextAutoplayCardVariant2Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: UpNextAutoplayCardVariant2DarkProps) {
    ...
    <>
      <div className="relative overflow-hidden rounded-lg bg-black ring-1 ring-white/10">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 p-4 text-center">
              <p className="text-xs font-medium text-gray-300">Up next in <span id="autoplay-2-count-dark">5</span></p>
            ...
            <div className="absolute inset-x-0 bottom-0 h-1 bg-white/20">
              <div id="autoplay-2-bar-dark" className="h-full w-0 bg-white transition-[width] duration-1000 ease-linear"></div>
            </div>
          </div>
    </>
  )
