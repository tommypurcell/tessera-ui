...
export type VerticalMenuVariant3DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function VerticalMenuVariant3Dark({ className, ...props }: VerticalMenuVariant3DarkProps) {
  return (
