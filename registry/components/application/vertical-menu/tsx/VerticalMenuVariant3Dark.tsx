...
export type VerticalMenuVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function VerticalMenuVariant3Dark({
  className,
  children,
  renderContent,
  before,
