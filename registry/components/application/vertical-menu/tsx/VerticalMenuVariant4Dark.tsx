...
export type VerticalMenuVariant4DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function VerticalMenuVariant4Dark({ className, ...props }: VerticalMenuVariant4DarkProps) {
  return (
      ...
      <ul className="space-y-1">
        ...
        <li>
          ...
          >
            ...
            <span className="shrink-0 rounded-full bg-gray-100 px-3 py-0.5 text-xs text-gray-600 group-hover:bg-gray-200 group-hover:text-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:group-hover:bg-gray-900 dark:group-hover:text-gray-100">
              5
            </span>
          </a>
        </li>
