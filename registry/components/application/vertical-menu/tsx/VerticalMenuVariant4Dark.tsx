...
export type VerticalMenuVariant4DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function VerticalMenuVariant4Dark({
  className,
  children,
  renderContent,
  before,
