...
export type VerticalMenuVariant6DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function VerticalMenuVariant6Dark({ className, ...props }: VerticalMenuVariant6DarkProps) {
  return (
