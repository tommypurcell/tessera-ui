...
export type VerticalMenuVariant7DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function VerticalMenuVariant7Dark({ className, ...props }: VerticalMenuVariant7DarkProps) {
  return (
