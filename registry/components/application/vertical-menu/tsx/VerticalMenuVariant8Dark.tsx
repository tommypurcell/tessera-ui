...
export type VerticalMenuVariant8DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function VerticalMenuVariant8Dark({
  className,
  children,
  renderContent,
  before,
