...
/**
 * Copy-and-own Tailwind component. Dark-surface variant of the video
 * discovery card.
 */
  ...
  return (
    <div className="flex w-64 flex-col gap-2.5">
      ...
      <div className="flex gap-2.5">
        <div aria-hidden="true" className="mt-0.5 size-8 shrink-0 rounded-full bg-gray-700" />
        <div className="min-w-0">
          <p className="line-clamp-2 text-sm font-medium text-gray-100">{title}</p>
