...
export type VisitorsMapVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function VisitorsMapVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  const defaultContent = (
    <>
      <div className="w-full max-w-md rounded-lg border border-gray-700 bg-gray-900 p-4 shadow-sm">
            ...
            <div className="relative mt-3 h-32 overflow-hidden rounded-md bg-gray-800/60">
              <svg viewBox="0 0 300 130" className="size-full">
                ...
                <circle cx="65" cy="50" r="4" fill="#34d399" opacity="0.9" />
                <circle cx="65" cy="50" r="9" fill="#34d399" opacity="0.25" />
                <circle cx="185" cy="45" r="4" fill="#34d399" opacity="0.9" />
                <circle cx="185" cy="45" r="9" fill="#34d399" opacity="0.25" />
                <circle cx="230" cy="50" r="3.5" fill="#34d399" opacity="0.9" />
                <circle cx="230" cy="50" r="8" fill="#34d399" opacity="0.25" />
                <circle cx="120" cy="95" r="3" fill="#34d399" opacity="0.8" />
              </svg>
            </div>
