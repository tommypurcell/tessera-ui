...
export type FieldAdornmentsVariant4Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function FieldAdornmentsVariant4({
  className,
  children,
  renderContent,
  before,
