...
export type FinishingTouchesVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function FinishingTouchesVariant3({
  className,
  children,
  renderContent,
  before,
