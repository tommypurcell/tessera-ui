...
export type HierarchyPatternsVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HierarchyPatternsVariant1({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HierarchyPatternsVariant1Props) {
