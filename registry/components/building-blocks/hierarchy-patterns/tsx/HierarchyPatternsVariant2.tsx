...
export type HierarchyPatternsVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HierarchyPatternsVariant2({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HierarchyPatternsVariant2Props) {
