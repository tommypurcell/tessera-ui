...
export type HierarchyPatternsVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HierarchyPatternsVariant3({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HierarchyPatternsVariant3Props) {
