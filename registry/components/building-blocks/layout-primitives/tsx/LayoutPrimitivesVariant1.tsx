...
export type LayoutPrimitivesVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function LayoutPrimitivesVariant1({
  className,
  children,
  renderContent,
  before,
