...
export type MediaPrimitivesVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function MediaPrimitivesVariant1({
  className,
  children,
  renderContent,
  before,
