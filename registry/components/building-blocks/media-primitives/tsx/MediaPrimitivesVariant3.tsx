...
export type MediaPrimitivesVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function MediaPrimitivesVariant3({
  className,
  children,
  renderContent,
  before,
