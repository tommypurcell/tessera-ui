...
export type NavigationAtomsVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function NavigationAtomsVariant3({
  className,
  children,
  renderContent,
  before,
