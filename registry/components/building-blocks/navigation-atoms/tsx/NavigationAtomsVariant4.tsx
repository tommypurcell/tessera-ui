...
export type NavigationAtomsVariant4Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function NavigationAtomsVariant4({
  className,
  children,
  renderContent,
  before,
