...
export type StartingPointsVariant1Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function StartingPointsVariant1({ className, ...props }: StartingPointsVariant1Props) {
  return (
