...
export type StatusPrimitivesVariant4Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function StatusPrimitivesVariant4({
  className,
  children,
  renderContent,
  before,
