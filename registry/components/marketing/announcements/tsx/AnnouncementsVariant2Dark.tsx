...
export type AnnouncementsVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function AnnouncementsVariant2Dark({ className, ...props }: AnnouncementsVariant2DarkProps) {
  return (
