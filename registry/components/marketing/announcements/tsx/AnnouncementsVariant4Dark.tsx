...
export type AnnouncementsVariant4DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function AnnouncementsVariant4Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: AnnouncementsVariant4DarkProps) {
