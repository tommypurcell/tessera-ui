...
export type AnnouncementsVariant5DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function AnnouncementsVariant5Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: AnnouncementsVariant5DarkProps) {
