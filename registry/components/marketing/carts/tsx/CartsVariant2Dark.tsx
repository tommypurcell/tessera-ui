...
export type CartsVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function CartsVariant2Dark({ className, ...props }: CartsVariant2DarkProps) {
  return (
    <div className={className} {...props}>
      <div
        className="relative w-screen max-w-sm border border-gray-300 bg-gray-100 px-4 py-8 sm:px-6 lg:px-8 dark:border-gray-600 dark:bg-gray-800"
        aria-modal="true"
        role="dialog"
        aria-label="Shopping cart"
        tabIndex={-1}
      >
        <button className="absolute inset-e-4 top-4 text-gray-600 transition hover:scale-110 dark:text-gray-300">
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-4">
              ...
              <div className="flex flex-1 items-center justify-end gap-2">
                ...
                <button className="text-gray-600 transition hover:text-red-600 dark:text-gray-300 dark:hover:text-red-300">
