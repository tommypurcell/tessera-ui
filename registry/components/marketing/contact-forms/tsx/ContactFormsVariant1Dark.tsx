...
export type ContactFormsVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ContactFormsVariant1Dark({
  className,
  children,
  renderContent,
  before,
