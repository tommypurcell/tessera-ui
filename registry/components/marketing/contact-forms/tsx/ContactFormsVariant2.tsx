...
export type ContactFormsVariant2Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function ContactFormsVariant2({ className, ...props }: ContactFormsVariant2Props) {
  return (
    <div className={className} {...props}>
      ...
      >
        ...
        <div>
          <label className="block text-sm font-medium text-gray-900" htmlFor="priority">
            Priority
          </label>
