...
export type ContactFormsVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ContactFormsVariant2Dark({
  className,
  children,
  renderContent,
  before,
