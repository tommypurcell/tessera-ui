...
export type ContactFormsVariant5DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ContactFormsVariant5Dark({
  className,
  children,
  renderContent,
  before,
