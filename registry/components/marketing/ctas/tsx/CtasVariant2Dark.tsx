...
export type CtasVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function CtasVariant2Dark({ className, ...props }: CtasVariant2DarkProps) {
  return (
            ...
            <form action="#" className="sm:flex sm:gap-4">
              <div className="sm:flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-md border-gray-200 bg-white p-3 shadow-xs transition focus:border-white focus:ring-2 focus:ring-yellow-400 focus:outline-hidden dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                />
              </div>
