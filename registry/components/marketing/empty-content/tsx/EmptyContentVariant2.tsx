...
export type EmptyContentVariant2Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function EmptyContentVariant2({ className, ...props }: EmptyContentVariant2Props) {
  return (
    <div className={className} {...props}>
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-6 text-2xl font-bold text-gray-900">Hmm, nothing found</h2>
