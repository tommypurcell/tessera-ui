...
export type EmptyContentVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function EmptyContentVariant3Dark({
  className,
  children,
  renderContent,
  before,
