...
export type EmptyContentVariant4DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function EmptyContentVariant4Dark({ className, ...props }: EmptyContentVariant4DarkProps) {
  return (
