...
export type EmptyContentVariant5DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function EmptyContentVariant5Dark({
  className,
  children,
  renderContent,
  before,
