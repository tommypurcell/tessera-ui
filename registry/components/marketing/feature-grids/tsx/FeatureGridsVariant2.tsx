...
export type FeatureGridsVariant2Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function FeatureGridsVariant2({ className, ...props }: FeatureGridsVariant2Props) {
  return (
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Collaboration tools</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Third-party connectors</h3>

                <p className="mt-1 text-gray-700">Connect with your favorite tools and services</p>
              </div>
            </div>
          </div>
        </div>
