...
export type FeatureGridsVariant4Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function FeatureGridsVariant4({ className, ...props }: FeatureGridsVariant4Props) {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex items-start gap-4 rounded-lg border border-gray-200 p-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Highly configurable</h3>
