...
export type FeatureGridsVariant4DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function FeatureGridsVariant4Dark({ className, ...props }: FeatureGridsVariant4DarkProps) {
  return (
