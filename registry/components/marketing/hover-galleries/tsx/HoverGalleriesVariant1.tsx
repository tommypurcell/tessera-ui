...
export type HoverGalleriesVariant1Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function HoverGalleriesVariant1({ className, ...props }: HoverGalleriesVariant1Props) {
  return (
    <div className={className} {...props}>
      <figure className="cycle-gallery rounded-xl border border-gray-200">
