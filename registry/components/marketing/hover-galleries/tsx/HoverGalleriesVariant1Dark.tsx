...
export type HoverGalleriesVariant1DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function HoverGalleriesVariant1Dark({ className, ...props }: HoverGalleriesVariant1DarkProps) {
  return (
    <div className={className} {...props}>
      <figure className="cycle-gallery rounded-xl border border-gray-800">
