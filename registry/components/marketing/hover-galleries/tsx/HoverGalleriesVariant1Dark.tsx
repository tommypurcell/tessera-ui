...
export type HoverGalleriesVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HoverGalleriesVariant1Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HoverGalleriesVariant1DarkProps) {
