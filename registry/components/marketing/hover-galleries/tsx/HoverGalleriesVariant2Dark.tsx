...
export type HoverGalleriesVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HoverGalleriesVariant2Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HoverGalleriesVariant2DarkProps) {
