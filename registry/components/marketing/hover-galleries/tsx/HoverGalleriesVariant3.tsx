...
export type HoverGalleriesVariant3Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function HoverGalleriesVariant3({ className, ...props }: HoverGalleriesVariant3Props) {
  return (
