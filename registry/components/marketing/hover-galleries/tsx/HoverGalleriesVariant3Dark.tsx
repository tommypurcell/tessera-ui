...
export type HoverGalleriesVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function HoverGalleriesVariant3Dark({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: HoverGalleriesVariant3DarkProps) {
