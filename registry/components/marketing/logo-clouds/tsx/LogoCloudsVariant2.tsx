...
export type LogoCloudsVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function LogoCloudsVariant2({
  className,
  children,
  renderContent,
  before,
    ...
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 grid grid-cols-2 gap-px md:grid-cols-4">
              <div className="grid place-content-center p-4 grayscale transition-[filter] hover:grayscale-0">
                <svg
