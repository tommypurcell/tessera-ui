...
export type LogoCloudsVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function LogoCloudsVariant3({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: LogoCloudsVariant3Props) {
  const defaultContent = (
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div className="max-w-lg">
              <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">Trusted by many</h2>
            ...
            <div
              className="mt-4 grid grid-cols-2 gap-px overflow-hidden rounded-lg *:bg-gray-100 md:grid-cols-4"
            >
              <div
                className="grid aspect-video place-content-center p-4 grayscale transition-[filter] hover:grayscale-0"
              >
                <svg
