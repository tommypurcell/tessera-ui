...
export type NewsletterSignupVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function NewsletterSignupVariant1({
  className,
  children,
  renderContent,
  before,
