...
export type NewsletterSignupVariant1Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function NewsletterSignupVariant1({ className, ...props }: NewsletterSignupVariant1Props) {
  return (
