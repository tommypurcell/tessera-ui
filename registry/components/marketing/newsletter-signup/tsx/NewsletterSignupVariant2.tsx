...
export type NewsletterSignupVariant2Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function NewsletterSignupVariant2({
  className,
  children,
  renderContent,
  before,
