...
export type ProductGalleryCardsVariant1Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ProductGalleryCardsVariant1({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ProductGalleryCardsVariant1Props) {
