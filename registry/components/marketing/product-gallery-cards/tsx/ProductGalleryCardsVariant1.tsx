...
export type ProductGalleryCardsVariant1Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function ProductGalleryCardsVariant1({ className, ...props }: ProductGalleryCardsVariant1Props) {
  return (
    <div className={className} {...props}>
      <div className="max-w-60 overflow-hidden rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="p-4">
              ...
              <p className="mt-1 text-sm text-gray-600">Heavyweight cotton with a relaxed, garment-dyed finish.</p>
            </div>
          </div>
    </div>
  )
