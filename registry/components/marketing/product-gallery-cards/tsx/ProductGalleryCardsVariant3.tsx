...
export type ProductGalleryCardsVariant3Props = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function ProductGalleryCardsVariant3({
  className,
  children,
  renderContent,
  before,
  ...
  errorContent,
  ...props
}: ProductGalleryCardsVariant3Props) {
