...
export type ProductGalleryCardsVariant3DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function ProductGalleryCardsVariant3Dark({ className, ...props }: ProductGalleryCardsVariant3DarkProps) {
  return (
