...
export type RotatingTextVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function RotatingTextVariant1Dark({
  className,
  children,
  renderContent,
  before,
