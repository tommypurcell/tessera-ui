...
export type RotatingTextVariant3DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function RotatingTextVariant3Dark({
  className,
  children,
  renderContent,
  before,
