...
export type TeamSectionsVariant1DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function TeamSectionsVariant1Dark({
  className,
  children,
  renderContent,
  before,
