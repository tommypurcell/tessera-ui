...
export type TeamSectionsVariant1DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function TeamSectionsVariant1Dark({ className, ...props }: TeamSectionsVariant1DarkProps) {
  return (
          ...
          <div>
            ...
            <div className="mt-4 flex items-center justify-between gap-4">
              ...
              >
                ...
                <svg viewBox="0 0 20 20" fill="currentColor" className="size-7" aria-hidden="true">
                  <path
