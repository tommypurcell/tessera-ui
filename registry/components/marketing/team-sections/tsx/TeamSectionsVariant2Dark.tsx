...
export type TeamSectionsVariant2DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function TeamSectionsVariant2Dark({ className, ...props }: TeamSectionsVariant2DarkProps) {
  return (
