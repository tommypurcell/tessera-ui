...
export type TeamSectionsVariant2DarkProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & {
 ...
 */
export function TeamSectionsVariant2Dark({
  className,
  children,
  renderContent,
  before,
