...
export type TeamSectionsVariant3DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function TeamSectionsVariant3Dark({ className, ...props }: TeamSectionsVariant3DarkProps) {
  return (
