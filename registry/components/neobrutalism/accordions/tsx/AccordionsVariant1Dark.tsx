...
export type AccordionsVariant1DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function AccordionsVariant1Dark({ className, ...props }: AccordionsVariant1DarkProps) {
  return (
