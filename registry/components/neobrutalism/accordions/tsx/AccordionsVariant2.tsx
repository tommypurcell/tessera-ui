...
export type AccordionsVariant2Props = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function AccordionsVariant2({ className, ...props }: AccordionsVariant2Props) {
  return (
    <div className={className} {...props}>
      <div className="space-y-3">
        <details className="group border-2 border-black shadow-[4px_4px_0_0] shadow-black [&_summary::-webkit-details-marker]:hidden">
          <summary className="flex cursor-pointer items-center justify-between gap-4 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-yellow-200 focus:bg-yellow-200 focus:outline-0">
