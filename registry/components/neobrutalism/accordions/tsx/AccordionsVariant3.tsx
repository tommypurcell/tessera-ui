...
export type AccordionsVariant3Props = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function AccordionsVariant3({ className, ...props }: AccordionsVariant3Props) {
  return (
    <div className={className} {...props}>
      <div className="divide-y-2 divide-black border-2 border-black shadow-[4px_4px_0_0] shadow-black">
