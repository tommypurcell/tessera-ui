...
export type AccordionsVariant3DarkProps = HTMLAttributes<HTMLDivElement>

/**
 * Native details and summary elements preserve keyboard and disclosure behavior.
 */
export function AccordionsVariant3Dark({ className, ...props }: AccordionsVariant3DarkProps) {
  return (
    <div className={className} {...props}>
      <div className="divide-y-2 divide-black border-2 border-black shadow-[4px_4px_0_0] shadow-black dark:divide-white dark:border-white dark:shadow-white">
