...
export type SaasLandingPageVariant1Props = HTMLAttributes<HTMLDivElement>

/**
 * Copy-and-own Tailwind component. Add application-specific state and event handlers where needed.
 */
export function SaasLandingPageVariant1({ className, ...props }: SaasLandingPageVariant1Props) {
  return (
